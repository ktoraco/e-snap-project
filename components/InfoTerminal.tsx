...
const InfoTerminal: FC = () => {
  ...
  return (
    <div className="bg-black text-gray-500 font-mono p-4 h-80 min-h-80 overflow-y-auto p-2 text-xs hidden-scrollbar rounded-lg terminal-scroll" style={{ scrollBehavior: 'smooth' }}>
